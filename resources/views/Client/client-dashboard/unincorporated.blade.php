...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <form class="col s12" method="POST" action="{{route('send_unincorporated')}}">
                 {{ csrf_field() }}
                  <div class="row">
                      
                        <div class="input-field col s4">
                                <input id="en_name" type="text" class="validate" name="en_name">
                                <label for="en_name">Propose enterprise name</label>
                     </div>
                     <div class="input-field col s4">
                    ...
                    <div class="input-field col s4">
                            ...
                            <label for="location">Production site / Location*</label>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="input-field col s4">
                       ...
                       <div class="input-field col s4 ">
                            ...
                            <label for="critical_cost">Critical cost centers*</label>
                    </div>
            ...
            <label>Physical challenge(s)</label>    
              </div>    
             </div>
